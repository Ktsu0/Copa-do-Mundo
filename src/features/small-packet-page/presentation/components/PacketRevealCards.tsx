...
const styles = StyleSheet.create({
  ...
  name: { fontSize: 10, fontWeight: '900', color: theme.colors.background },
  ...
  newTagText: { fontSize: 8, fontWeight: '900', color: theme.colors.text },
  button: {
    backgroundColor: theme.colors.primary,
    width: width * 0.65,
  ...
  buttonText: { ...theme.typography.body, fontWeight: '800', color: theme.colors.background, letterSpacing: 1 },
});
